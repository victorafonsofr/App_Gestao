...
public class CadastrarCLT extends javax.swing.JInternalFrame {
    ...
    private void jCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCadastrarActionPerformed
        ...
        salarioBruto = Double.parseDouble(jTsalario.getText()); //PEGA O TEXTO STRING E PASSA PARA DOUBLE
        acoes.inserirCLT(nome, endereco, cpf, salarioBruto);
        
        JOptionPane.showMessageDialog(rootPane, "Registro inserido!");
        //limpar texto escrito anteriormente
